    ...
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in duration-700">
      ...
      <div className="space-y-12">
        ...
        <section className="border-4 border-swiss-fg bg-swiss-bg overflow-hidden">
          <div className="p-8 border-b-4 border-swiss-fg bg-swiss-muted flex items-center gap-4 swiss-dots">
            <User className="w-6 h-6" />
            <h2 className="text-xl font-black tracking-widest uppercase">01. USER PROFILE</h2>
          </div>
          <div className="p-12 grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input 
                  type="email" 
                  defaultValue="saikat@communitysync.io"
                  className="w-full p-4 border-4 border-swiss-fg bg-swiss-muted focus:bg-white focus:border-swiss-red outline-none font-bold text-xs tracking-widest transition-all"
                />
              </div>
            </div>
            <div className="flex flex-col items-center justify-center border-4 border-dashed border-swiss-fg/20 p-8 hover:border-swiss-red transition-colors group cursor-pointer">
              <div className="w-24 h-24 bg-swiss-red border-4 border-swiss-fg flex items-center justify-center mb-4 group-hover:scale-105 transition-transform">
                <User className="w-10 h-10 text-swiss-bg" />
              </div>
              <p className="text-[10px] font-black tracking-widest uppercase text-swiss-fg/40">UPLOAD PHOTO</p>
            </div>
          </div>
        </section>
        ...
        {/* Danger Zone */}
        <section className="border-4 border-swiss-red bg-swiss-red/5 p-12 flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
          ...
          <button className="px-12 py-4 border-4 border-swiss-red text-swiss-red font-black tracking-widest uppercase hover:bg-swiss-red hover:text-swiss-bg transition-all">
            DELETE ACCOUNT
          </button>
        </section>
      </div>
      ...
      {/* Save Button Fixed */}
      <div className="pt-12 border-t-4 border-swiss-fg flex justify-end">
        <button className="px-16 py-8 bg-swiss-fg text-swiss-bg font-black tracking-widest uppercase hover:bg-swiss-red transition-colors flex items-center gap-4 shadow-[12px_12px_0_0_rgba(255,48,0,1)]">
          SAVE ALL CHANGES
